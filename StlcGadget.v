...
Module StlcGadget.
  ...
  Inductive mode := Verifier | Prover.
  ...
  |ST_gadget_Verifier: forall f w x c f' x' c' w',
      f =Verifier=> f' ->                                    (** Bring f' to StlcRing *)
      x =Verifier=> x' ->                                    (** Bring x' to StlcRing *)
      c =Verifier=> c' ->                                    (** Bring c' to StlcRing *)
      <{ f' x' }> -->* w' ->                                (** Compute witness w' in Coq proof *)
      <[let w := f with x in c]> =Verifier=> <{ c' x' w' }> (** Verifier checks witness c' x' w' *)            
